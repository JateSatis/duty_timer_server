...
const transformRequestsForResponse = (requestIds) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const usersInfo = yield Promise.all(requests.map((request) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (request.reciever.accountInfo.avatarImageName) {
            avatarLink = yield imagesConfig_1.S3DataSource.getImageUrlFromS3(request.reciever.accountInfo.avatarImageName);
        }
        const sentFriendshipRequestInfo = {
            id: request.id,
...
//# sourceMappingURL=transfrormRequestsForResponse.js.map