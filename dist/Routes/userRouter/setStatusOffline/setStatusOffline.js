...
exports.setStatusOfflineRoute = void 0;
const User_1 = require("../../../model/database/User");
const GlobalErrors_1 = require("../../utils/errors/GlobalErrors");
const socketsConfig_1 = require("../../../sockets/socketsConfig");
const setStatusOfflineRoute = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (webSocketFriendsMapValue) {
        ...
        const userOfflineResponseBodyWS = {
            userId: user.id,
        };
...
exports.setStatusOfflineRoute = setStatusOfflineRoute;
//# sourceMappingURL=setStatusOffline.js.map