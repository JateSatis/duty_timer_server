...
exports.auth = exports.PUB_ACCESS_KEY = exports.pathToPublicAcessKey = void 0;
...
exports.pathToPublicAcessKey = path.join(__dirname, "/jwt/keys/public_access_key.pem");
exports.PUB_ACCESS_KEY = fs.readFileSync(exports.pathToPublicAcessKey);
const authMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    jsonwebtoken.verify(token, exports.PUB_ACCESS_KEY, {
        algorithms: ["RS256"],
        ...
        if (error) {
            ...
            if (decoded && typeof decoded !== "string") {
                ...
                if (!user.accountInfo.isVerified) {
                    return res.status(404).json((0, GlobalErrors_1.err)(new AuthErrors_1.ACCOUNT_NOT_VERIFIED()));
                }
                req.body.user = user;
                next();
            }
